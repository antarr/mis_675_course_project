...
class DonationsControllerTest < ActionController::TestCase
  ...
  test "should create donation" do
    assert_difference('Donation.count') do
      post :create, donation: { amount: @donation.amount, date_given: @donation.date_given, donation_type: @donation.donation_type }
    end
  ...
  test "should update donation" do
    put :update, id: @donation, donation: { amount: @donation.amount, date_given: @donation.date_given, donation_type: @donation.donation_type }
    assert_redirected_to donation_path(assigns(:donation))
  end
